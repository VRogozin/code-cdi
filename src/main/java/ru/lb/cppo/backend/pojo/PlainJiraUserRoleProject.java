...
public class PlainJiraUserRoleProject {
    ...
    public PlainJiraUserRoleProject(){
    }

    public PlainJiraUserRoleProject(String juserName, String juserKey, String juserDispName, String projectName,
            String juserRole) {
